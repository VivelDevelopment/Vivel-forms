...
function Copyright() {
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      <Link color="inherit" href="https://vivel.tech">
        Vivel forms
      </Link>
      { ' © '}
      <Link color="inherit" href="https://github.com/VivelDevelopment">
        GitHub
      </Link>{' '}
    ...
    <div>
      ...
      <footer className={classes.footer} style={{}}>
        <Typography variant="h6" align="center" gutterBottom>
          Vivel Forms <small>(An Open source forms)</small>
        </Typography>
        <Typography variant="subtitle1" align="center" color="textSecondary" component="p">
          No Copyright issue. This project is <Link color="inherit" href="https://github.com/VivelDevelopment/Vivel-forms">open source</Link>{'. '}
